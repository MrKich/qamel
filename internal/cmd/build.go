...
import (
	...
	"github.com/MrKich/qamel/internal/generator"
...
func buildHandler(cmd *cobra.Command, args []string) {
	...
	vendorDir := fp.Join(projectDir, "vendor", "github.com", "MrKich", "qamel")
	...
	if !dirExists(qamelDir) {
		...
		qamelDir = fp.Join(gopath, "src", "github.com", "MrKich", "qamel")
	}
