/****************************************************************************
** Meta object code from reading C++ file 'qamel-backend.cpp'
**
...
#error "The header file 'qamel-backend.cpp' doesn't include <QObject>."
...
void BackEnd::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->timeChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BackEnd::timeChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void BackEnd::timeChanged(QString _t1)
{
